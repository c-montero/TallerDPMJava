...
public class BasicosFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextInputEditText edtApellidos = binding.edtApellidos;
        ...
        btnBoton.setOnClickListener(v -> {
            ...
            String apellidos = Objects.requireNonNull(edtApellidos.getText()).toString();
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<>(requireContext(), android.R.layout.simple_spinner_item, estados);
